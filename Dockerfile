# Docker image for gotify using the  template
ARG LICENSE="MIT"
ARG IMAGE_NAME="gotify"
ARG PHP_SERVER="gotify"
ARG BUILD_DATE="Fri Aug 18 10:13:51 PM EDT 2023"
...
ENV HOSTNAME="casjaysdev-gotify"
...
LABEL org.opencontainers.image.url="https://hub.docker.com/r/casjaysdevdocker/gotify/${IMAGE_NAME}"
LABEL org.opencontainers.image.vcs-url="https://github.com/casjaysdevdocker/gotify/${IMAGE_NAME}"
LABEL org.opencontainers.image.url.source="https://github.com/casjaysdevdocker/gotify/${IMAGE_NAME}"
LABEL org.opencontainers.image.documentation="https://hub.docker.com/r/casjaysdevdocker/gotify/${IMAGE_NAME}"
