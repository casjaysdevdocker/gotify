...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202308182129-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  WTFPL
# @@ReadME           :  gotify.sh --help
# @@Copyright        :  Copyright: (c) 2023 Jason Hempstead, Casjays Developments
# @@Created          :  Friday, Aug 18, 2023 21:29 EDT
# @@File             :  gotify.sh
# @@Description      :
...
GOTIFY_DEFAULTUSER_NAME="${root_user_name:-}"
GOTIFY_DEFAULTUSER_PASS="${root_user_pass:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Specifiy custom directories to be created
ADD_APPLICATION_FILES=""
ADD_APPLICATION_DIRS=""
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
APPLICATION_FILES="$LOG_DIR/gotify.log"
...
CMD_ENV=""
[ -f "/config/gotify/.env.gotify" ] && . /config/gotify/.env.gotify
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
__update_conf_files() {
  ...
  # replace variables
  # __replace "" "" "$CONF_DIR/gotify.conf"
